...
event1 = Event.create!(
  ...
  start_time: DateTime.new(2024, 5, 11, 21, 0),
  end_time: DateTime.new(2024, 5, 11, 23, 0),
...
event4 = Event.create!(
  ...
  fight_type: "programmed",
  place: "Downtown Rooftop",
  start_time: DateTime.new(2024, 8, 1, 20, 0),
  end_time: DateTime.new(2024, 8, 1, 22, 0),
  target: "Control of the skies (or at least the rooftop)",
  description: "A high-stakes fight with the city's skyline as the backdrop.",
  user: user4,
  fighter: fighter2,
  status: "pending"
)
...
event6 = Event.create!(
  ...
  start_time: DateTime.new(2024, 6, 25, 18, 0),
  end_time: DateTime.new(2024, 6, 25, 19, 0),
...
event10 = Event.create!(
  ...
  fight_type: "ambush",
  place: "Downtown Mall",
  start_time: DateTime.new(2024, 8, 10, 14, 0),
  end_time: DateTime.new(2024, 8, 10, 16, 0),
...
event12 = Event.create!(
  ...
  start_time: DateTime.new(2024, 6, 20, 21, 0),
  end_time: DateTime.new(2024, 6, 20, 23, 0),
